...
<switch onclick="myFunction()"><i class="far fa-moon"></i></switch>
...
<div class="container-fluid my=5 pt-5 pb-5">
  <div class="row text-center">
    ...
    <?php echo $totaldailyincrease ?></small>
    </div>
    <div class="col-4 text-success">
      <h4>Recovered</h4>
      <?php echo $totalrec ?>
      <small class="pl-1"> <i class="fas fa-plus"></i>
    <?php echo $totaldailyrec ?></small>
    </div>
    <div class="col-4">
      <h4>Deceased</h4>
      <?php echo $totaldec ?>
      <small class="pl-1"><i class="fas fa-plus"></i>
    <?php echo $totaldailydec ?></small>
    </div>
  </div>
</div>
